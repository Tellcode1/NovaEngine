...
extern void nv_gpu_create_sampler(nvvk_driver* driver, const nv_gpu_sampler_create_info* pInfo, nv_gpu_sampler_t** dst);
extern void nv_gpu_destroy_sampler(nvvk_driver* driver, nv_gpu_sampler_t* sampler);
