...
extern int nv_gpu_create_framebuffer(nvvk_ctx_t* vkctx, const nv_gpu_framebuffer_create_info_t* pCreateInfo, nv_gpu_framebuffer_t* dst);

extern void nv_gpu_destroy_framebuffer(nvvk_ctx_t* vkctx, nv_gpu_framebuffer_t* dst);
