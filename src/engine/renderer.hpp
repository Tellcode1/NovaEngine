...
struct nv_renderer
{
  ...
  nv_gpu_memory_block_t quad_memory;

  void* mapped;
};

extern nv_error nv_renderer_init(struct nv_ctx* ctx, lr::nvsm_ctx_t* nvsmctx, nvvk_driver* driver, const nv_renderer_config* conf, nv_renderer_t* dst);
