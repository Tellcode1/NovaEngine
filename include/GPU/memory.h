...
extern void nv_gpu_allocate_memory(size_t size, nv_gpu_memory_usage usage, nv_gpu_memory **dst);
extern void nv_gpu_free_memory(nv_gpu_memory *mem);

extern void nv_gpu_map_memory(nv_gpu_memory *memory, size_t size, size_t offset, void **out);
extern void nv_gpu_unmap_memory(nv_gpu_memory *memory);
