...
{
  nv_gpu_create_buffer(sizeof(nv_vertex_t) * nvertices + sizeof(u32) * nindices, 1, NOVA_GPU_BUFFER_TYPE_VERTEX_BUFFER | NOVA_GPU_BUFFER_TYPE_INDEX_BUFFER, &dst->m_buf);
